...
public class WFCMutualDataExchange {
    public static void main(String[] args) throws Exception {
        ...
        try(ImportCSVToVector importer = new ImportCSVToVector(System.getProperty("user.home") +
                "\\Downloads\\java-developer-data-exchange-master\\java-developer-data-exchange-master\\balances.csv")) {
